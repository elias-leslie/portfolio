...
![SHA security control plane dashboard smoke test](./docs/images/sha-control-plane-dashboard.png)
...
![A-Term browser workspace](./docs/images/a-term-workspace.png)
...
- [Security Architect Resume (PDF)](./docs/Resume_Elias_Leslie_Architecture.pdf)
- [Security Architect Resume (Markdown)](./docs/Resume_Elias_Leslie_Architecture.md)
