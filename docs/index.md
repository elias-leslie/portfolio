...
![SHA security control plane dashboard smoke test](./images/sha-control-plane-dashboard.png)
...
![Portfolio AI investing watchlist](./images/portfolio-ai-watchlist.png)
